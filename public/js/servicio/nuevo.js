$(function() {
    ...
    //Obtener valores de servicios seleccionados
    $(document).ready(function(){
        //Marca los selects con el estilo de Material Design.
        $('select').material_select();
        //  var $options = $('select#id_servicio option');
        $($('select#id_servicio option')[0]).attr('selected', 'true');
        // .attr('selected');
        var input = $('#id_servicio').val();
        $('#id_servicio_input').val(input);
    });
