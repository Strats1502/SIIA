$(function() {
    ...
    $(".editar-button").click(function() {
        ...
        limite_promocion = $($(this).parent().siblings()[0].children[4]).val();
        repetible = $($(this).parent().siblings()[0].children[5]).val();
        repetible = repetible == "1" ? true : false;
        ...
        $("#editlimite").val(limite_promocion);
        $("#editrepetible").attr('checked', repetible);
    ...
    $("#form-editar").validate({
        ...
        messages: {
            ...
            "limite": "Este campo debe ser mayor a uno"
        },
        errorElement: 'div',
