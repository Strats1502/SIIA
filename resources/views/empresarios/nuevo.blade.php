...
@section('head')
    <script type="text/javascript" src="{{url('/js/empresario/nuevo.js')}}"></script>
...
@section('contenedor')
  ...
  <div class="row" id="nuevo-registro">
    ...
    @endforeach
    <form id="form-nj" method="post" action="{{url('/empresarios/crear')}}" class="col s12" enctype="multipart/form-data">
      <div id="DUsuario" class="col s12">
        
        <input type="hidden" name="_token" value="{{ csrf_token() }}">
        <div class="row" id="cntr">
          <div class="col s12">
            <img id="image" class="circle" src="{{url('/img/empresarios/default-user-image.png')}}" height="180" width="180"></img>
          </div>
          <div class="row " id="cntr">
        ...
        <div class="row" id="cntr">
          <div class="col s12 m3">
            ...
            <select id="id_estado_nacimiento" name="estado_nacimiento" >
        ...
        <div class="col s12 m3" style="padding-top: 100px;" >
          <input type="submit" class="input-field btn accent-color" value="Registrar">
        </div>
