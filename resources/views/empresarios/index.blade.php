...
@section('title')
    {{trans('strignore.menu.menu_2.titulo')}}
@endsection

@section('head')
    <script type="text/javascript" src="{{url('/js/empresario/index.js')}}"></script>
@endsection
...
@section('contenedor')
    ...
    <!-- Cuerpo del index -->
    <div class="row">
        <h5>{{trans('strignore.menu.menu_2.titulo')}}</h5>
        ...
        <div class="col s1">
            <div class="fixed-action-btn">
                <a class="btn-floating btn-large waves-effect waves-light accent-color" href="{{url('empresarios/nuevo')}}"><i class="material-icons">add</i></a>
            </div>      
        </div>
    </div>
    
    @include('empresarios.lista')
