...
<head>
    ...
    <title>Registro exitoso - ADMIC</title>
                            ...
                            <tbody><tr>
                                <td class="" style="padding: 20px 0; text-align: center; ;">
                                    ...
                                    <a href="https://twitter.com/guanajoven?lang=es" style="text-decoration: none; ;" target="_blank">
                                        ...
                                        <img alt="ADMIC" class=" " src="http://www.meetroopers.com/sites/default/files/styles/medium_white_bkg/public/imgs/comunidades/guanajoven.png?itok=eGemqsU6" style="border: 0; height: auto; max-width: 100%; vertical-align: middle; ;" width="102">
                                    ...
                                    <table cellpadding="0" cellspacing="0" dir="ltr" style="border: 0; width: 100%;">
                                        ...
                                        <tbody><tr>
                                            <td class="" style="padding: 20px 0; text-align: center; ;">
                                                ...
                                                <img alt="error" class=" " src="{{url('/img/logo.png')}}" style="border: 0; height: auto; max-width: 100%; vertical-align: middle; ;" width="200">
