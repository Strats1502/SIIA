            ...
            <table class="highlight">
                <thead>
                    <tr>
                        ...
                        <!-- <th class="header" data-field="id_estatus" style="width: 100px; cursor: pointer">Estatus<i class="material-icons grey-text">{{$columna === "estatus" ? ($tipo === "def" ? "unfold_more" : ($tipo === "asc" ? "expand_less" : "expand_more")) : "unfold_more"}}</i></th> -->
                        <th style="width: 50px" data-field="editar">Editar</th>
                        <th style="width: 50px" data-field="eliminar">Eliminar</th>
                    </tr>   
                </thead>
                <tbody id="tabla-orden">
                        @foreach($ordenes as $orden)
                            <tr>
                                ...
                                <!-- Volver a poner estatus <td style="width: 150px;">$orden->estatus->nombre</td> -->
