...
<div class="row">
    ...
    <form id="form" method="post" action="{{url('/servicios/registrar')}}" class="col s12" enctype="multipart/form-data">
        ...
        <div class="row">
            ...
            <div class="input-field col s12 m6">
                <select id="estatus" class="select-wrapper validate" name="estatus">
        ...
        <div class="row">
            ...
            <div class="input-field col s12 m6">
                <input type="hidden" name="id_servicio_input" id="id_servicio_input">
                <select id="id_servicio" class="select-wrapper validate" name="id_servicio" multiple>
