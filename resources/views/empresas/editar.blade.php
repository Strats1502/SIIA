        ...
        <div class="modal-content">
            ...
            <div class="row">
                ...
                <div class="input-field col s6">
                    <input id="editlimite" name="limite" type="number" class="validate">
                    <label class="isTrue" for="editlimite">Limite de Promoción</label>
                </div>
                <div class="input-field col s6">
                    <input id="editrepetible" name="repetible" type="checkbox"  class="validate">
                    <label classs="isTrue" for="editrepetible">Múltiples promociones por usuario</label>
                </div>
                <input class="input-field btn right accent-color" type="submit" value="EDITAR">
              </form>
              </div>
    </div>
  </div>
    ...
    <div id="addPromocion" class="modal">
        <div class="modal-content">
            ...
            <div class="row">
                ...
                <div class="input-field col s6">
                    <input id="limite" name="limite" type="number"  class="validate">
                    <label for="limite">Limite de Promoción</label>
                </div>
                <div class="input-field col s6">
                    <input id="repetible" name="repetible" type="checkbox"  class="validate">
                    <label for="repetible">Múltiples promociones por usuario</label>
                </div>
                
                <input class="input-field btn right accent-color" type="submit" value="AGREGAR">
              </form>
              </div>
    </div>
  </div>
        ...
        @endforeach
            ...
            <div class="row">
                ...
                <div class="input-field col s12 m6">
                    ...
                    <input class="input-field btn right accent-color" type="submit" value="ACTUALIZAR">
            </div>
               ...
               <div class="section" id="doc-container">
                 <table class="highlight">
                  ...
                  <td>
                    ...
                    <input type="hidden" name="limite_promocion" value="{{$promocion->usos_restantes}}">
                    <input type="hidden" name="repetible" value="{{$promocion->repetible}}"> 
                    {{$promocion->titulo}}
                  </td>
                  ...
                  <td> <a class="btn-floating halfway-fab waves-effect waves-light grey  editar-button"><i class="material-icons">mode_edit</i></a></td>
                    <td><a href="{{url('/promociones/eliminarPromocion/'.$promocion->id_promocion.'/'.$empresa->id_empresa)}}" class="btn-floating halfway-fab waves-effect waves-light grey" id="delete-button"><i class="material-icons">clear</i></a></td>
                </tr>
      @endforeach
                     </tbody>
                 </table>
