...
@section('head')
    <script type="text/javascript" src="{{url('/js/eventos/estadisticas.js')}}"> </script>
...
@section('contenedor')
    ...
    <h5 style="margin-top: -30px; display: inline-block;">{{ $evento->titulo }}</h5>
        <button class="waves-effect waves-light btn rose-code accent-color" id="exportar" style="float: right; display: block;">Exportar</button>
    </div>
    ...
    <div class="row">
        ...
        <table id="tabla-asistentes" class="display highlight" cellspacing="0" width="100%">
            ...
            <tr>
                ...
                <th data-field="id_guanajoven">ID ADMIC</th>
